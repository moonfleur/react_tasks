...
const ColorPicker = React.createClass ({
    ...
    handlePutIcon() {
        this.setState({
            image: <i className="fas fa-check"/>
        });
    },
    ...
    render() {
        return (
            <div className="allCircles">
                <div className="colorCircle" style={{ backgroundColor: '#E63462'}} onClick={this.handlePutIcon} id="redColor">{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#FE5F55'}}>{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#8bef54'}}>{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#008536'}}>{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#00B4A6'}}>{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#007DB6'}}>{this.state.image}</div>
                <div className="colorCircle" style={{ backgroundColor: '#9c00ff'}}>{this.state.image}</div>
            </div>
        )
    }
});
